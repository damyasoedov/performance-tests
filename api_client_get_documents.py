...
open_credit_account_response = accounts_gateway_client.open_credit_card_account(user_id)
print('Open credit card account response:', open_credit_account_response)
