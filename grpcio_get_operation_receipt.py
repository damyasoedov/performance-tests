...
print('Open debit card account response: {}'.format(open_debit_card_account_response))
...
print('Make top up operation response: {}'.format(make_top_up_operation_response))
...
print('Get operation receipt response: {}'.format(get_operation_receipt_response))
