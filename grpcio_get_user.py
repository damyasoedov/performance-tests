...
print('Create user response type:', type(create_user_response))
print(create_user_response.user)
print(create_user_response.user.__dict__)
print(create_user_response.__dict__)

user_id_to_get = create_user_response.user.id
get_user_request = GetUserRequest(id=user_id_to_get)
