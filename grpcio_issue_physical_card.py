...
create_credit_card_account_request = OpenCreditCardAccountRequest(
    user_id=create_user_response.user.id,
)
create_credit_card_account_response: OpenCreditCardAccountResponse = \
    accounts_gateway_service.OpenCreditCardAccount(create_credit_card_account_request)
print('Create credit card account response:', create_credit_card_account_response)

issue_physical_card_request = IssuePhysicalCardRequest(
    user_id=create_user_response.user.id,
    account_id=create_credit_card_account_response.account.id,
)
